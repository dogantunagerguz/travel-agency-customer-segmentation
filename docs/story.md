...
*The original project narrative is preserved below. Run all commands from the repository root.*

# From "Who Are Our Loyal Customers?" to Hotel Recommendations

![Dashboard](../assets/dashboard.png)

*Insights — booking lead time, customer lifecycle filters, and seasonal sales. [View all dashboard pages](dashboard.md).*
...
The dashboard walkthrough, with screenshots of all three report pages, is in [docs/dashboard.md](dashboard.md).
